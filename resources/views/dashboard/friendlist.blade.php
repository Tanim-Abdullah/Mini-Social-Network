...
<div class="sidenav">
  ...
  <a href="{{route('logout')}}">Logout</a>
   ...
   <div class="all">
        ...
        <div id='main'>
                <div id='sidebar'>
            <img src="" height="198" width="200"/>
                </div>
            
                    <div id='page-wrap'>
             <table border='1'>
             <tr><th>Name:</th><td>sohel</td></tr>
             <tr><th>category:</th><td>kjkj</td></tr>
             <tr><th>price:</th><td>kjkj</td></tr>
             <tr><th>Place:</th><td>jnh</td></tr>
          </table>
                     </div>
              </br>
                <div id='description-button'>
                <a class='btn' href=''>View Full Description</a>
                </div>
               </br>
              </div>
               </br>
